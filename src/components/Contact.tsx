          ...
          <div className="flex gap-4">
            ...
            >
              <svg
                ...
                className="w-8 h-8"
              >
                <path d="M20 4H4c-1.103 0-2 .897-2 2v12c0 1.103.897 2 2 2h16c1.103 0 2-.897 2-2V6c0-1.103-.897-2-2-2zM6.203 7.5L12 13.5l5.797-6C18.971 6.41 18.14 6 17 6H7c-1.14 0-1.97.41-2.203 1.5zM12 15.6c-.723 0-1.303-.554-1.303-1.237 0-.693.58-1.237 1.303-1.237s1.304.544 1.304 1.237c0 .683-.58 1.237-1.304 1.237z" />
              </svg>
            </a>
          </div>
